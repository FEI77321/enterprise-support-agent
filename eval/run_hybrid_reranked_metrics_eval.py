...
from app.retrieval_fusion import search_hybrid_reranked
...
def main() -> None:
    ...
    print()
    print(f"Hybrid Reranked Macro Recall@{TOP_K}: {recall:.4f}")
    print(f"Hybrid Reranked MRR@{TOP_K}: {mrr:.4f}")
    print(f"Hybrid Reranked nDCG@{TOP_K}: {ndcg:.4f}")
